...
class MyApp extends PolymerElement {
      ...
      <app-drawer-layout fullbleed="" narrow="{{narrow}}">
        ...
        <app-header-layout has-scrolling-region="">
          ...
          <iron-pages selected="[[page]]" attr-for-selected="name" role="main">
            ...
            <stock-view name="stockview"></stock-view>
            <stock-anlysis name="stockanlysis"></stock-anlysis>
  ...
  _routePageChanged(page) {
    ...
    if (!page) {
      this.page = 'stockview';
    } else if (['mylogin','stockview','stockanlysis'].indexOf(page) !== -1) {
      this.page = page;
    } else {
      this.page = 'view404';
    }
  ...
  _pageChanged(page) {
    ...
    switch (page) {     
      case 'stockview':
        import('./stock-view.js');
        break;
      case 'stockanlysis':
        import('./stock-anlysis');
        break;
      case 'view404':
